...
return [
    ...
    | versiones, como las reglas de tamaño. Puedes modificar cada uno de estos mensajes aquí.
    |
    */
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas se usan para intercambiar el marcador de atributo
    | por algo más legible, como "Dirección de correo" en lugar de "email".
    |
    */
